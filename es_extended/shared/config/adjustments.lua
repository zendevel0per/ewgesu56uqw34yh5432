...
Config.SpawnVehMaxUpgrades = true -- ยานพาหนะที่เกิดจาก admin จะมีการตั้งค่าการปรับแต่งสูงสุด
Config.CustomAIPlates = "SIXTYSIX.66" -- ป้ายทะเบียนแบบกำหนดเองสำหรับยานพาหนะ AI
